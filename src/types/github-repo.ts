...
export interface ProjectConfig {
  $schema?: string
  project_type: 'landing-page' | 'webapp' | 'mobile' | 'desktop' | 'api' | 'library'
  status: 'completed' | 'in-progress' | 'maintenance' | 'archived'
  description: Translations
  featured: boolean
  comment?: Translations
  technologies?: {
    [K in keyof Technologies]?: (keyof Technologies[K])[]
  }
  tags?: string[]
}
export interface ProjectMetadata extends ProjectConfig {
  primary_image: Image
  images: Image[]
}
